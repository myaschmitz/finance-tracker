...
export default function Account() {
    ...
    useEffect(() => {
        fetch('http://localhost:9000/user/1')
            .then((res) => res.json())
    ...
    return (
        <div className="container">
            <h1 className="text-4xl font-bold section-title">Account</h1>
            ...
            <div>
                <h1 className="text-3xl font-bold section-title">Danger Zone</h1>
                ...
                <button className="underline delete-account">Delete my account.</button>
            </div>
        </div>
    )
}